...
The **workspace menu** can be accessed by right-clicking on any workspace.  There you will find many features.  Below are a few cool ones to help with workflow and development process:

- **user-menu-choice:** gives you the ability to extend default menus to add custom user-defined functionality.  For example, a sub-menu option created to change the workspace and all subworkspaces colors.
...
.. image:: /img/g2/CodeExampleRecursive.png
